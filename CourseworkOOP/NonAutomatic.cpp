...
NonAutomatic::NonAutomatic(std::string name, std::string description, const Ammo ammunition, int magazine_capacity, int amount_of_ammo) : FirearmBase(name, description, ammunition, magazine_capacity, amount_of_ammo)
{
}
